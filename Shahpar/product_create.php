...
<body>
    <fieldset>
        ...
        <form action="actions/a_product_create.php" method="post" enctype="multipart/form-data">
            <table class='table'>
                <tr>
                    <th>Name</th>
                ...
                <tr>
                    ...
                    <td><a href="product.php"><button class='btn btn-warning' type="button">Home</button></a></td>
                </tr>
            </table>
        </form>
    </fieldset>
