...
<html>
    ...
    <body>
        <fieldset>
            ...
            <form action="actions/a_product_update.php"  method="post" enctype="multipart/form-data">
                <table class="table">
                    <tr>
                        <th>Name</th>
                    ...
                    <tr>
                        ...
                        <td><a href= "product.php"><button class="btn btn-warning" type="button">Back</button></a></td>
                    </tr>
                </table>
            </form>
        </fieldset>
